...
async def start_command(ctx):
    ...
    await info(ctx)
    #çok klasik bir başlangıç mesajı, daha iyi bir şey yapılabilir.
...
Ayrıca, proje adını yazarak projeyle ilgili tüm bilgilere göz atabilirsiniz!""")
    #daha da fazla fonksiyion eklenebilir, bu yüzden bu komutun içeriği değiştirilebilir.
...
async def get_projects(ctx):
    ...
    if projects:
        ...
        #biraz emir kipleri kullanılmış, daha nazik bir dil kullanılabilir.
...
async def skills(ctx):
    ...
    if projects:
        ...
        await ctx.send("\n".join(projects))
        #Allah Allah, anlaşılması zor bir cümle olmuş, daha iyi bir şekilde ifade edilebilir.
...
async def delete_project(ctx):
    ...
    if projects:
        ...
        await ctx.send("\n".join(projects))
        #çok zor bu daha kolay olabilirdi ama neyse
...
async def update_projects(ctx):
    ...
    if projects:
        ...
        await ctx.send("\n".join(projects))
        #bu zor öğrenilebilir ama neyse
